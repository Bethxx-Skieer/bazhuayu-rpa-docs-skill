...
| 文件 | 作用 |
| --- | --- |
| `SKILL.md` | **核心文档**。完整的文章审计 8 项清单、执行 SOP、踩坑注意事项、整站 404 排查流程，以及 2026-09 近期实战补充要点（大分类标题化、表格图可点击放大、加粗失效根因、旧链接替换、首页重写、清理纪律、部署失败排查、rebase 推送、域名差异、JPEG 误标 PNG）。 |
...
> 仅阅读手册时忽略上述安装步骤，直接看 `SKILL.md` 即可。
